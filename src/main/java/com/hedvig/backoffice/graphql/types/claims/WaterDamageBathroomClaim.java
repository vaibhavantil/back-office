...
@Value
@UnionType
public class WaterDamageBathroomClaim {
  LocalDate date;

  public static WaterDamageBathroomClaim fromClaimData(List<ClaimData> claimData) {
    LocalDate date = null;
    ...
    return new WaterDamageBathroomClaim(date);
  }
}
