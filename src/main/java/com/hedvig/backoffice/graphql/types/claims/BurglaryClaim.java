...
public class BurglaryClaim {
  ...
  public static BurglaryClaim fromClaimData(List<ClaimData> claimData) {
    ...
    return new BurglaryClaim(location, date, item, policeReport, receipt);
  }
}
