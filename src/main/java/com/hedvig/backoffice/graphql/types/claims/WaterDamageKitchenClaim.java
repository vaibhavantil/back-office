...
@Value
@UnionType
public class WaterDamageKitchenClaim {
  LocalDate date;

  public static WaterDamageKitchenClaim fromClaimData(List<ClaimData> claimData) {
    LocalDate date = null;
    ...
    return new WaterDamageKitchenClaim(date);
  }
}
