...
public interface PaymentServiceClient {
    ...
    DirectDebitStatusDTO getDirectDebitStatusByMemberId(@RequestHeader("Hedvig.Token") String memberId);
    ...
    @GetMapping("/_/members/{memberId}/payoutMethod/status")
    PayoutMethodStatusDTO getPayoutMethodStatusByMemberId(@PathVariable String memberId);
}
